...
Expected Master's Degree Completion: August, 2016 \\
...
\begin{rSection}{Research Experience}
	...
	\begin{itemize}
	\item Participated in pair distribution experiments on glass forming metallic liquids using a neutron electrostatic levatator performed at NOMAD, SNS, Oak Ridge National Labratory (ORNL)
...
\begin{rSection}{Presentations}
	...
	\\
	\\
	Talk, University of Illinois Urbana-Champaign Nuclear Engineering Undergraduate Seminar, {\it{``Homogenous Nucleation and Crystal Growth in a Model Liquid from Direct Energy Landscape Sampling Simulations"}} \hfill {April, 2016} \\
		\\
...
\\
\\
{\it{The Hacker Within: University of Illinois Urbana-Champaign}}, A organization for compuational scienties to share and practice compuational skills. \hspace{5cm}August, 2015 -- present
\\
\\
